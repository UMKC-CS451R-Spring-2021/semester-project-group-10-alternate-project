        ...
        <div className = "container">
            ...
            <div className = "wrapper">
                <div className = "side-dashboard">
                    ...
                    <div class="sidebar-buttons active">Courses</div>
                ...
                <div className = "course-side">
                    <div className = "course-side-content">
                        ...
                        <div className = "course-body">
                            {/* <div className = "course-side-checkbox"><input  type = "checkbox"></input> <div>ML 4400</div></div>
                            <div className = "name-key"><input  type = "checkbox"></input> CS 470</div>
                            <div className = "course-side-checkbox"><input  type = "checkbox"></input> Comedy101</div>
                            <div className = "course-side-checkbox"><input  type = "checkbox"></input> STATA</div> */}
                        </div>
